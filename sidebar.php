...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text" style="margin-top: 0.25rem;font-size: 1.2rem;">WA JVR</div>
            </a>
            ...
            <li class="<?php echo $menu == 8 ? $aktif : $nonaktif  ?>">
                <a class="nav-link" href="https://documenter.getpostman.com/view/16028509/Uyr4JKMr" target="_blank">
